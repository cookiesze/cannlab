...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin/theme/assets/font-awesome/css/font-awesome.min.css') }}"
        type="text/css" />
    <link rel="stylesheet" href="{{ asset('admin/theme/assets/material-design-icons/material-design-icons.css') }}"
        type="text/css" />

    <link rel="stylesheet" href="{{ asset('admin/theme/assets/bootstrap/dist/css/bootstrap.min.css') }}"
        type="text/css" />
    ...
    <script src="https://cdn.tiny.cloud/1/4ucvvl87nyhyln5eyny6wjf70jh8hsrsas390xgor2gc9ysx/tinymce/6/tinymce.min.js"
    ...
    <script src="https://cdn.tiny.cloud/1/4ucvvl87nyhyln5eyny6wjf70jh8hsrsas390xgor2gc9ysx/tinymce/6/plugins.min.js"
        referrerpolicy="origin"></script>
