                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="content-box">
                                            ...
                                            <div class="">
                                                <p>
                                                    <strong>{{ $product->slug }}</strong> | <strong>น้ำหนัก</strong> {{ $product->dimension }}
                                                    |
                                             </div>
                                            <div class="text">
                                            <h2>สั่งซื้อได้ที่</h2>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="title-s2">
                                                    <a href="{{ $product->make }}" target="_blank"><img src="https://www.tvpoolreward.com/assets/onsite/shopee-button.gif" class="" width="200px;" style="padding-bottom: 20px;" alt=""></a>
                                                    <a href="{{ $product->barcode }}" target="_blank"><img src="https://www.tvpoolreward.com/assets/onsite/lz.png" class="" width="200px" alt="" style="padding-bottom: 20px;"></a>
                                                </div>
                                            </div>
                                            <!--
