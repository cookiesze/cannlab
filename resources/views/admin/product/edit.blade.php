        ...
        <form action="{{ url('/admin/update-products/'.$products->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3 form-group">
                    ...
                    <input type="text" value="{{ $products->barcode }}" class="form-control" name="barcode" placeholder="Lazada Link">
                </div>
                <div class="col-md-6 mb-3 form-group">
                ...
                <div class="col-md-6 mb-3 form-group">
                    ...
                    <input type="text" value="{{ $products->made }}" class="form-control" name="made" placeholder="Shopee Link">
                </div>
