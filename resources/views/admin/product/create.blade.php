    ...
    <div class="padding">
        ...
        @csrf
            <div class="row">
                ...
                <div class="col-md-6 mb-3 form-group">
                    <label for="">Lazada Link</label>
                    <input type="text" class="form-control" name="barcode" placeholder="Lazada Link">
                </div>
                <div class="col-md-6 mb-3 form-group">
                ...
                <div class="col-md-6 mb-3 form-group">
                    <label for="">Shopee Link</label>
                    <input type="text" class="form-control" name="made" @error('made') border-red-500 @enderror placeholder="Shopee Link" value="{{old('made')}}">
                    @error('made')
                    <div class="text-sm text-red-600"></div>
                    @enderror
                </div>
